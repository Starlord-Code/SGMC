    ...
    <div class="card shadow mb-4">
        ...
        <?php
            ...
            //{
                ...
                $id=$_SESSION['ID'];
                $query = "SELECT * FROM coursementor WHERE id= '$id'";
                ...
                foreach($query_run as $row)
                {
                    ?>
                        ...
                        <form action="code.php" method="POST">
                            ...
                            <a href="course mentor homepage.php" class="btn btn-danger"> CANCEL </a>
                            <button type="submit" name="updateprocm" class="btn btn-primary"> Update </button>
