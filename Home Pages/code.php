...
if(isset($_POST['updateproca']))
{
    ...
    $dob = $_POST['edit_dob'];
    $address = $_POST['edit_address'];
    $query = "UPDATE classadvisor SET username='$username', Firstname='$fname', Lastname='$lname', subject='$subject', section='$section', branch='$branch', year='$year', Phone='$phone', DOB='$dob' , MailID='$mailid' , Address='$address' WHERE id='$id' ";
    $query_run = mysqli_query($db, $query);
    ...
    if($query_run)
    {
        $_SESSION['status'] = "Your Data is Updated";
        $_SESSION['status_code'] = "success";
        $MSG = 'Location: CA_profile_edit.php';
        header($MSG); 
    }
    else
    {
...
if(isset($_POST['updateprocm']))
{
    ...
    $dob = $_POST['edit_dob'];
    $address = $_POST['edit_address'];
    $query = "UPDATE coursementor SET username='$username', Firstname='$fname', Lastname='$lname', subject='$subject', Branch='$branch', Year='$year', Section='$section', Phone='$phone', DOB='$dob' , MailID='$mailid' , Address='$address' WHERE id='$id' ";
    $query_run = mysqli_query($db, $query);
    ...
    if($query_run)
    {
        $_SESSION['status'] = "Your Data is Updated";
        $_SESSION['status_code'] = "success";
        $MSG = 'Location: CM_profile_edit.php';
        header($MSG); 
    }
    else
    {
...
if(isset($_POST['updateprochf']))
{
    ...
    $dob = $_POST['edit_dob'];
    $address = $_POST['edit_address'];
    $query = "UPDATE coursehandlingfaculty SET username='$username', Firstname='$fname', Lastname='$lname', subject='$subject', Section='$section', Branch='$branch', Year='$year', Phone='$phone', DOB='$dob' , MailID='$mailid' , Address='$address' WHERE id='$id' ";
    $query_run = mysqli_query($db, $query);
    ...
    if($query_run)
    {
        $_SESSION['status'] = "Your Data is Updated";
        $_SESSION['status_code'] = "success";
        $MSG = 'Location: CHF_profile_edit.php';
        header($MSG); 
    }
    else
    {
...
if(isset($_POST['updateproec']))
{
    ...
    $dob = $_POST['edit_dob'];
    $address = $_POST['edit_address'];
    $query = "UPDATE examcoordinator SET username='$username', Firstname='$fname', Lastname='$lname', Phone='$phone', DOB='$dob' , MailID='$mailid' , Address='$address' WHERE id='$id' ";
    $query_run = mysqli_query($db, $query);
    ...
    if($query_run)
    {
        $_SESSION['status'] = "Your Data is Updated";
        $_SESSION['status_code'] = "success";
        $MSG = 'Location: EC_profile_edit.php';
        header($MSG); 
    }
    else
    {
...
if(isset($_POST['updateprogma']))
{
    ...
    if($query_run)
    {
        $_SESSION['status'] = "Your Data is Updated";
        $_SESSION['status_code'] = "success";
        $MSG = 'Location: GMA_profile_edit.php';
        header($MSG); 
    }
    else
    {
