            ...
            <div class="inner">
                ...
                <nav id="menu">
                    <ul>
                        ...
                        <li>
                            ...
                            <ul>
                                <li><a href="./CA_profile_edit.php?id=167">Edit Profile</a></li>
                                <li>
                                    <a href="#"></a>
                                </li>
                                <li><a href="./CA_Pwd.php">Change Password</a></li>
                                <li>
                                    <a href="#"></a>
                                </li>
                ...
                <footer id="footer ">
                    <p class="copyright ">Copyright &copy; 15CSE313 CSE-B Group-8
                        <br>Designed by <a rel="nofollow " href="# ">Karan and Harsha</a></p>
                </footer>
                 <!-- Logout Modal-->
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <form action="logout_CA.php" method="POST"> 
