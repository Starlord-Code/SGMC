            ...
            <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 col-xs-12 main">
                ...
                <div class="row">
                    <div class="col-xs-12 col-md-10 col-md-push-1 col-lg-8 col-lg-push-2 well">
                        <form id="form" accept-charset="UTF-8" action="./pwd_ec.php" autocomplete="on" class="form-horizontal" method="post">
                        ...
                        <button type="button" class="btn btn-info" onclick="location.href = './Exam Coordinator homepage.php';">Go back</button>
                    </div>
                </div>
            </div>
        </div>
