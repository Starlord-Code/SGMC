...
session_start();
include('../config.php');
include('includes_EC/header.php');
?>
...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary"> EDIT Exam Coordinator info </h6>
        </div>
        <div class="card-body">
        <?php
            ...
            //{
                ...
                $id=$_SESSION['ID'];
                $query = "SELECT * FROM examcoordinator WHERE id= '$id'";
                ...
                foreach($query_run as $row)
                {
                    ?>
                        ...
                        <form action="code.php" method="POST">
                            ...
                            <a href="Event Coordinator homepage.php" class="btn btn-danger"> CANCEL </a>
                            <button type="submit" name="updateproec" class="btn btn-primary"> Update </button>
...
<?php
    ...
    include('includes_EC/scripts.php');
    include('includes_EC/footer.php');
?>