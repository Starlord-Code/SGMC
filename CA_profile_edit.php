...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary"> EDIT Class Advisor info </h6>
        </div>
        <div class="card-body">
        <?php
            ...
            //{
                ...
                $id=$_SESSION['ID'];
                $query = "SELECT * FROM classadvisor WHERE id= '$id'";
                ...
                foreach($query_run as $row)
                {
                    ?>
                        ...
                        <form action="code.php" method="POST">
                            ...
                            <a href="class advisor homepage.php" class="btn btn-danger"> CANCEL </a>
                            <button type="submit" name="updateproca" class="btn btn-primary"> Update </button>
